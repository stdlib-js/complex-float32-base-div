...
```javascript
import div from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-div@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign, strided } from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-div@deno/mod.js';
```
