...
```javascript
div = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-div@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var div = require( 'path/to/vendor/umd/complex-float32-base-div/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-div@umd/browser.js"></script>
```
...
#### div.assign( re1, im1, re2, im2, out, strideOut, offsetOut )
...
#### div.strided( z1, sz1, oz1, z2, sz2, oz2, out, so, oo )
...
var v = div.strided( z1, 1, 0, z2, 1, 0, out, 1, 0 );
// returns <Float32Array>[ 5.0, 3.0 ]
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/complex-float32-base-div.svg
[npm-url]: https://npmjs.org/package/@stdlib/complex-float32-base-div

[test-image]: https://github.com/stdlib-js/complex-float32-base-div/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/complex-float32-base-div/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/complex-float32-base-div/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/complex-float32-base-div?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/complex-float32-base-div.svg
[dependencies-url]: https://david-dm.org/stdlib-js/complex-float32-base-div/main
...
[deno-url]: https://github.com/stdlib-js/complex-float32-base-div/tree/deno
[deno-readme]: https://github.com/stdlib-js/complex-float32-base-div/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/complex-float32-base-div/tree/umd
[umd-readme]: https://github.com/stdlib-js/complex-float32-base-div/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/complex-float32-base-div/tree/esm
[esm-readme]: https://github.com/stdlib-js/complex-float32-base-div/blob/esm/README.md
